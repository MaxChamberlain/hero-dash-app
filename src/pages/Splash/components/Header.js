  ...
  return (
    <>
      <motion.div
        ...
        className="h-12 bg-slate-900 fixed top-0 left-0 right-0 flex justify-center"
      >
        <div className='flex'>
        ...
        <div className='fixed top-1.5 right-6 flex'>
          <Link to='/register?id=new'>
            <div className='text-lg rounded px-1 py-0.5 cursor-pointer' style={{ border: '1px solid #ff8000' }}>Register</div>
          </Link>
          <Link to='/login'>
