...
export default function Settings(){
    ...
    const canManage = JSON.parse(localStorage.getItem('@ViDash:_userInfo')).canManage;
    ...
    return (
        ...
        >
            ...
            <div className='flex justify-around'>
                <div className='bg-slate-50 w-80 rounded p-2 flex flex-col h-fit'>
                ...
                <div className='bg-slate-50 w-full ml-5 rounded p-2 flex flex-col'>
